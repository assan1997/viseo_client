      ...
      <div className='row h-100 ' style={{ position: 'relative' }}>
        <div className='col-2 contact_zone_options'>
          <Fab size='small' className='items' color='primary'>
            {' '}
            <ContactsIcon onClick={onDisplayContact} />
          </Fab>
          <Fab size='small' className='items' color='primary'>
            {' '}
            <ChatIcon onClick={onDisplayMessage} />
          </Fab>
          <Fab size='small' className='items' color='primary'>
            {' '}
            <CallIcon onClick={onDisplayMessage} />
          </Fab>
        </div>
        <div className='col-10'>
          <div className='row h-100'>
            <div className='col-12 ' style={{ height: '10%', width: '100%' }}>
              <div className='row h-100'>
                <div
                  className={`col-12 finder_zone ${
                ...
                <div
                  className={`col-12  findzone-placeholder ${
